...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data_path", type=str,
                        default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/data_prepare/processed_data_llama3_4hidden_long.jsonl")
    ...
    parser.add_argument("--sp_weight", type=float, default=2.0)
    ...
    parser.add_argument("--max_train_samples", type=int, default=4200)
    parser.add_argument("--max_distill_tokens_per_sample", type=int, default=64)
    parser.add_argument("--use_tensorboard", type=bool, default=True)
    parser.add_argument("--log_dir", type=str, default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/runs/llama_post_train_z3")
    parser.add_argument("--log_interval", type=int, default=1)
    parser.add_argument("--save_dir", type=str,
                        default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/llama_z3/adaptor")
    parser.add_argument("--save_backbone_dir", type=str,
                        default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/llama_z3/backbone")
    parser.add_argument("--router_save_dir", type=str,
                        default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/llama_z3/router")
