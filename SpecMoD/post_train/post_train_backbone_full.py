...
def train_func(config):
    ...
    for i in range(1, LAYERS):
        if i == 34:
            ...
            adaptor_weight_path = (
                f"/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/"
                f"final_model/adaptor/8B/adapter_layer_{i}_1024_Model3_0.95.pt"
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log_dir", type=str, default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/runs/adaptor_full_backbone_post_train")
    parser.add_argument("--log_interval", type=int, default=1)
    parser.add_argument("--save_dir", type=str,
                        default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/adaptor_with_full_backbone")
    parser.add_argument("--save_backbone_dir", type=str,
                        default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/full_backbone")
