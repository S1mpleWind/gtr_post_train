...
def main(args):
    ...
    for i in range(1, LAYERS):
        ...
        if i == 31:
            ...
            layer_adaptor_weight = torch.load(f"{args.adaptor_dir}/adapter_layer_{i}_1024_Model3.pt")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--backbone_dir", type=str, default ="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/llama_backbone/backbone_final_v1.pt")
