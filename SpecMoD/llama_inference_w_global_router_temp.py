'''
This file is mainly designed for collecting data with backbone only
...
def main(args):
    from model.llama_model_w_adaptor_w_global_router import Spec_LlamaForCausalLM
    ...
    ori_model = Spec_LlamaForCausalLM.from_pretrained(
        ...
        # 显式设置 pad token，避免 generate 自动回退到 eos 的提示
    if tokenizer.pad_token_id is None:
        tokenizer.pad_token = tokenizer.eos_token

    tokenizer.padding_side = "left"  # 批量推理推荐；单条也可保留
    ori_model.config.pad_token_id = tokenizer.pad_token_id
    ori_model.generation_config.pad_token_id = tokenizer.pad_token_id
    ori_model.generation_config.eos_token_id = tokenizer.eos_token_id
    ...
    router_weight = torch.load("/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/final_model/global_router/Llama3.1_8B_global_router_1024_Model1_non_thinking.pt")
    ...
    for i in range(1, LAYERS):
        if i == 34:
            ...
            layer_adaptor_weight = torch.load(f"/home/xujiaming/xujiaming/models/llama_adaptor/adapter_layer_{i}_1024_Model3.pt")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str, default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/benchmark_llama")
    ...
    parser.add_argument("--backbone_dir", type=str, default ="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/llama_backbone/backbone_final_1.pt")

    parser.add_argument("--write_record", action="store_true")
