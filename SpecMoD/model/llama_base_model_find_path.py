...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # print('all_hidden_states.shape', [h.shape for h in all_hidden_states])
...
class Spec_LlamaForCausalLM(LlamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        storage.add_last_hidden_states(torch.cat([all_hidden_states[2], all_hidden_states[self.config.num_hidden_layers//2], all_hidden_states[self.config.num_hidden_layers-3]], dim =-1))
