        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if past_key_value is not None:
            ...
            if past_key_value.get_seq_length(self.layer_idx) > 0:
                ...
                input_shape = hidden_states[:,-1:,:].shape[:-1]
...
class Qwen3Model(Qwen3PreTrainedModel):
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        #     logits = layer_router(inputs_embeds)
        ...
        if hidden_states.shape[1] == 1:
            spec_hidden_state = spec_model.topK_generate(
                hidden_states = last_hidden_state,
                input_ids = self.input_ids,
            )
            features = torch.cat([last_hidden_state[:,-1:,:], hidden_states, spec_hidden_state], dim = -1)
            layer_router.eval()
            logits = layer_router(features)
            layer_index = logits > 0
        ...
        for decoder_layer in self.layers[: self.config.num_hidden_layers]:
            ...
            if hidden_states.shape[1] == 1:
                ...
                if layer_index[0,0,decoder_layer.layer_index] == 0:
                    continue
                new_hidden_states, new_position_embeddings = past_hidden_states.get_data(decoder_layer.layer_index)
            else:
            ...
            if self.gradient_checkpointing and self.training:
                ...
                layer_outputs = decoder_layer(
                    ...
                    # flag = layer_index[0,0,decoder_layer.layer_index] if hidden_states.shape[1] == 1 else True,
                    **flash_attn_kwargs,
                )
