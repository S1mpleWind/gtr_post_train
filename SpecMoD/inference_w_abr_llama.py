...
def main(args):
    from model.llama_model_adaptor_global_router_new import  Spec_LlamaForCausalLM
    ...
    router_weight = torch.load("/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/llama_n1/router/router.pt")
    #router_weight = torch.load("/home/xujiaming/xujiaming/models/Llama3.1_8B_global_router_1024_Model1_non_thinking.pt")
    ...
    for question in tqdm.tqdm(questions):
        ...
        if hasattr(ori_model.model, "input_id_init"):
            ...
            raise AttributeError("model has neither input_id_init() nor input_ids")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--adaptor_dir",type=str,default = "/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/llama_n1/adaptor")

    parser.add_argument("--use_backbone",type=bool,default = False)
    parser.add_argument("--backbone_dir", type=str, default ="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/llama_n1/backbone/backbone_final.pt")
