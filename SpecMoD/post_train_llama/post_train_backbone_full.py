...
if __name__ == "__main__":
    ...
    parser.add_argument("--log_dir", type=str, default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/runs/llama_post_train_v3")
    parser.add_argument("--log_interval", type=int, default=1)
    parser.add_argument("--save_dir", type=str,
                        default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/llama_adaptor_v3")
    parser.add_argument("--save_backbone_dir", type=str,
                        default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/checkpoint/llama_backbone_v3")
