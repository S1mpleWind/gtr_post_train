...
def main(args):
    ...
    ori_model = Spec_Qwen3ForCausalLM.from_pretrained(model_path,
                                                      attn_implementation="flash_attention_2" 
                                                      ).half().to('cuda')
    
    # spec_model
    Spec_model_path = "/home/xujiaming/xujiaming/models/Qwen3-8B_eagle3"
    spec_model = SpecModel.from_pretrained(Spec_model_path=Spec_model_path, 
    ...
    for i in range(1, LAYERS):
        if i == 34:
            ...
            layer_adaptor_weight = torch.load(f"/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/SpecMoD/final_model/adaptor/8B/adapter_layer_{i}_1024_Model3_0.95.pt")
    ...
    if args.write_record :
        with open(os.path.join(args.out_dir, "record_stats_base.txt"), "a", encoding="utf-8") as f:
            f.write("record id: {}\n".format(args.dataset))
    ...
    # with open("/home/xujiaming/xujiaming/jiaoyifan/benchmark/prompts.jsonl", "w", encoding="utf-8") as f:
    #     for prompt_obj in prompts_list:
    #         f.write(json.dumps(prompt_obj, ensure_ascii=False) + "\n")


    # with open("/home/xujiaming/xujiaming/jiaoyifan/benchmark/outputs.json", "w", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str, default="/home/xujiaming/xujiaming/jiaoyifan/gtr_post_train/benchmark")
