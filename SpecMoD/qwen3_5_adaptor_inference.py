...
class Qwen3_5TextModel(Qwen3_5PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # [jyf:]
        # add hidden of the last decoder layer
        all_hidden_states += (hidden_states,)
        # [jyf]

        hidden_states = self.norm(hidden_states)         #TODO: all_hidden_states
            ...
            for layer in range(1, self.config.num_hidden_layers+1):
                ...
                for budget in range(1, layer):
                    ...
                    layer_outputs = self.layers[layer-1](
                        hidden_states = dp[layer-1][budget - 1],
                        attention_mask= layer_mask,
                        position_ids=text_position_ids,
...
class Qwen3_5ForCausalLM(Qwen3_5PreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        # [jyf:]
        self.model = Qwen3_5TextModel(config.text_config)
